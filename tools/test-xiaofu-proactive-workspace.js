...
const activityState = require("../miniprogram/services/agentActivityState");
...
assert.ok(pageJs.includes("agentActivityState.activityPatchForRunEvent"), "page consumes the unified RunEvent state reducer");
assert.strictEqual(activityState.activityPatchForRunEvent({ type: "provider.started" }).agentActivityState, "thinking");
assert.notStrictEqual(activityState.activityPatchForRunEvent({ type: "provider.selected" }).agentActivityState, "thinking", "Thinking is driven only by provider.started");
