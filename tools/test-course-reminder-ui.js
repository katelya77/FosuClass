...
assert.ok(!sheetJs.includes('makeIdempotencyKey("toggle-apply"'), "toggle confirmation must reuse one idempotency key");
assert.ok(!sheetJs.includes('makeIdempotencyKey("lead-apply"'), "lead update confirmation must reuse one idempotency key");
assert.ok(!sheetJs.includes('makeIdempotencyKey("delete-apply"'), "delete confirmation must reuse one idempotency key");
