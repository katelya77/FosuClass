...
function assertStaticHtml(html) {
  ...
  assertIncludes(html, 'id="dailyKnowledgePolicyEnabled"', "daily knowledge global enable switch");
  assertIncludes(html, 'id="dailyKnowledgeStrategy"', "daily knowledge rotation strategy");
  assertIncludes(html, 'id="dailyKnowledgeRotationOffset"', "daily knowledge rotation offset");
  assertIncludes(html, 'id="saveDailyKnowledgePolicyButton"', "daily knowledge policy save action");
  assertIncludes(html, 'id="seedDailyKnowledgeButton"', "daily knowledge builtin takeover action");
  assertIncludes(html, 'id="dailyKnowledgeSearch"', "daily knowledge search filter");
  assertIncludes(html, 'id="selectDailyKnowledgePageButton"', "daily knowledge page selection");
  assertIncludes(html, 'id="enableDailyKnowledgeBulkButton"', "daily knowledge bulk enable action");
  assertIncludes(html, 'id="disableDailyKnowledgeBulkButton"', "daily knowledge bulk disable action");
  assertIncludes(html, 'id="deleteDailyKnowledgeBulkButton"', "daily knowledge bulk delete action");
  assertIncludes(html, 'id="dailyKnowledgePrevButton"', "daily knowledge previous page action");
  assertIncludes(html, 'id="dailyKnowledgeNextButton"', "daily knowledge next page action");
  assertIncludes(html, 'id="dailyKnowledgeExportScope"', "daily knowledge export scope");
  assertIncludes(html, 'id="dailyKnowledgeExportButton"', "daily knowledge export action");
  ...
  assertIncludes(html, "/api/admin/daily-knowledge/policy", "daily knowledge policy API");
  assertIncludes(html, "/api/admin/daily-knowledge/bulk", "daily knowledge bulk API");
  assertIncludes(html, "/api/admin/daily-knowledge/export", "daily knowledge export API");
  assertIncludes(html, "/api/admin/daily-knowledge/seed-builtin", "daily knowledge builtin takeover API");
