...
assertIncludes(html, 'id="publisherQuickTermInput"', "single-term publisher input");
assertIncludes(html, 'id="copyPublisherTermCommandBtn"', "single-command publisher action");
assertIncludes(html, "npm run sync:publish -- --term=", "publisher command must always carry the selected term");
assertIncludes(html, 'id="runExpiredStagingUploadsBtn"', "high-privilege expired data cleanup action");
