...
assert(appJson.pages.includes("packageXiaofu/pages/ai-assistant/ai-assistant"), "app.json must include ai-assistant page");
...
assert(entryText.includes("/packageXiaofu/pages/ai-assistant/ai-assistant"), "index/school/today should reference ai-assistant route");
