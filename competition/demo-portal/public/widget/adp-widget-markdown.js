...
function Wl() {
  ...
  function s(_, E) {
    ...
    return _.content.indexOf("[ ] ") === 0 ? F.content = '<input class="taadp-list-item-checkbox"' + v + 'type="checkbox">' : (_.content.indexOf("[x] ") === 0 || _.content.indexOf("[X] ") === 0) && (F.content = '<input class="taadp-list-item-checkbox" checked=""' + v + 'type="checkbox">'), F;
  }
  function o(_) {
