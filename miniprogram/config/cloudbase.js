...
const DAILY_KNOWLEDGE_CLOUDBASE_ENABLED = true;
const DAILY_KNOWLEDGE_REGISTRY_COLLECTION = "fosu_daily_knowledge_registry";
...
module.exports = {
  ...
  DAILY_KNOWLEDGE_CLOUDBASE_ENABLED,
  DAILY_KNOWLEDGE_REGISTRY_COLLECTION,
