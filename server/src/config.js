...
const config = {
  ...
  FOSU_IMPORT_CHANNEL_STRATEGY: process.env.FOSU_IMPORT_CHANNEL_STRATEGY || "auto",
  FOSU_IMPORT_CLOUDBASE_RELAY_URL: process.env.FOSU_IMPORT_CLOUDBASE_RELAY_URL || "",
  FOSU_IMPORT_CLOUDBASE_RELAY_TOKEN: process.env.FOSU_IMPORT_CLOUDBASE_RELAY_TOKEN || "",
  FOSU_IMPORT_CLOUDBASE_TIMEOUT_MS: parseInt(process.env.FOSU_IMPORT_CLOUDBASE_TIMEOUT_MS || "25000", 10),
