...
const DEFAULT_DOCS = [
  ...
  },
  {
    ...
    body: "小序默认不保存学号、密码、Cookie、完整个人课表和精确位置轨迹。用户主动授权时，只发送完成任务所需的最小课表摘要。",
  },
  {
...
const DEFAULT_RULES = [
  {
    ...
    scope: ALL_SCOPES,
    tags: ["help"],
    keywords: ["你是谁", "小序", "小佛", "能做什么", "帮助", "介绍一下自己", "自我介绍"],
    synonyms: ["你是谁呀", "你叫什么", "小序是谁", "小佛是谁"],
    intentName: "project_qa",
    priority: 90,
    body: "小序是佛课小表校园助手。可查课表、空教室、教学周、天气和校园入口，也可说明个人课表导入。课程事实以工具核验为准。正式版回复应自然变化，避免固定模板。",
    reply: "我是小序，佛课小表里的校园助手。可以帮你查课表、找空教室、看教学周和天气，也能说明怎么导入个人课表。",
    suggestions: ["你能做什么", "查今日课表", "现在有空教室吗？"],
