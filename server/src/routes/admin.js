  ...
  try {
    ...
    return res.json({
      ...
      data: {
        ...
        providerDecisionReason: payload.safety && payload.safety.providerDecisionReason || "",
        fallbackReason: payload.safety && payload.safety.fallbackReason || "",
        keyConfigured: Boolean(providerStatus.openrouterKeyConfigured || providerStatus.deepseekKeyConfigured || providerStatus.cozeKeyConfigured || providerStatus.cloudbaseOpenaiKeyConfigured),
    ...
    return res.status(200).json({
      ...
      data: {
        ...
        keyConfigured: Boolean(process.env.OPENROUTER_API_KEY || process.env.AI_API_KEY || process.env.DEEPSEEK_API_KEY || process.env.COZE_API_KEY || process.env.CLOUDBASE_OPENAI_API_KEY),
