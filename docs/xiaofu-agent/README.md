...
- `unified-model-first-root-cause.md`：代码审计、根因和基线证据。
...
知识库、MCP、Hybrid RAG、课程提醒等专项文档仍保留为子系统说明。旧版 UI V2/V3、旧迁移计划和旧 Final Convergence 设计已由统一架构文档替代，避免继续把历史阶段描述当成当前事实。
